using HopeAcademySMS.BusinessLogic;
...
namespace HopeAcademySMS.Controllers
{
    public class ResultsController : Controller
    {
                ...
                foreach (var listStudent in student)
                {
                    ...
                    else
                    {
                        ...
                        var result = new Result
                        {
                            ...
                            NoOfSubjectOffered = ResultCommand.SubjectOfferedByStudent(studentNumber, model.TermName.ToString()),
        ...
        public ActionResult Edit(ResultViewModel model)
        {
            ...
            //    var result = await db.Results.FindAsync(model.ResultId);

            //    if (result == null)
            //    {
            //        return HttpNotFound();
            //    }
            //    result.Updateresult(model.StudentId, model.ClassName, model.TermName.ToString(),
            //                          model.SessionName, model.SubjectCode);
